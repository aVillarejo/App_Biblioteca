...
Namespace BDDBIBLIOTECADataSetTableAdapters
    ...
    Partial Public Class TBL_LIBROSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TBL_LIBROS] ([Titulo], [Autor], [ID_Categoria], [Existe]) VALU"& _ 
                "ES (@Titulo, @Autor, @ID_Categoria, @Existe);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID_LIBRO, Titulo, Autor, I"& _ 
                "D_Categoria, Existe FROM TBL_LIBROS WHERE (ID_LIBRO = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBL_LIBROS] SET [Titulo] = @Titulo, [Autor] = @Autor, [ID_Categoria"& _ 
                "] = @ID_Categoria, [Existe] = @Existe WHERE (([ID_LIBRO] = @Original_ID_LIBRO) A"& _ 
                "ND ((@IsNull_Titulo = 1 AND [Titulo] IS NULL) OR ([Titulo] = @Original_Titulo)) "& _ 
                "AND ((@IsNull_Autor = 1 AND [Autor] IS NULL) OR ([Autor] = @Original_Autor)) AND"& _ 
                " ([ID_Categoria] = @Original_ID_Categoria) AND ([Existe] = @Original_Existe));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                "SELECT ID_LIBRO, Titulo, Autor, ID_Categoria, Existe FROM TBL_LIBROS WHERE (ID_L"& _ 
                "IBRO = @ID_LIBRO)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT ID_LIBRO, Titulo, Autor, ID_Categoria, Existe FROM dbo.TBL_LIBROS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
